...
The simulation and analysis of results was carried out in R statistics and made extensive use of several packages, including "survey" \autocite{lumley_survey:_2014}, "ggplot2" \autocite{wickham_ggplot2:_2015} and "Hmisc" \autocite{jr_hmisc:_2015}. An online repository containing the IPF code, the resulting simulation weights, and the source for the analyses and figures presented in this paper is available online at https://github.com/a-fent/microsim-ipf.
\clearpage
#+END_LaTeX
