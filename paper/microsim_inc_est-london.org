...
#+AUTHOR: Alex Fenton
#+PROPERTY: header-args:R :session *R-LondonSimulation* :eval no-export
...
#+BEGIN_LaTeX
\ifdef{\CASEcontact}{\CASEcontact{196}{July 2016}}{}
\clearpage
\listoftables
\listoffigures
\clearpage
...
#+RESULTS[49ec43b4acbd1473404a5043de8dd70e429ac484]: table:rmse-2001-fit-src
#+BEGIN_LaTeX
 %latex.default(fit.01, file = "", numeric.dollar = FALSE, big.mark = ",",     cdec = rep(0, 5), n.rgroup = c(4, 5), rgroup = c("Adult",         "Household"), n.cgroup = c(2, 1, 1, 1), cgroup = c("Constraint",         "Hhold Only", "Multi-Level", "SPI"), caption = "Root mean squared error of the constraint variables in the three simulations, 2001",     label = "table:rmse-2001-fit")%
\begin{table}[!tbp]
\caption{Root mean squared error of the constraint variables in the three simulations, 2001\label{table:rmse-2001-fit}} 
\begin{center}
\begin{tabular}{lrrcrcrcr}
\hline\hline
\multicolumn{1}{l}{\bfseries fit.01}&\multicolumn{2}{c}{\bfseries Constraint}&\multicolumn{1}{c}{\bfseries }&\multicolumn{1}{c}{\bfseries Hhold Only}&\multicolumn{1}{c}{\bfseries }&\multicolumn{1}{c}{\bfseries Multi-Level}&\multicolumn{1}{c}{\bfseries }&\multicolumn{1}{c}{\bfseries SPI}\tabularnewline
\cline{2-3} \cline{5-5} \cline{7-7} \cline{9-9}
\multicolumn{1}{l}{}&\multicolumn{1}{c}{Areas}&\multicolumn{1}{c}{Classes}&\multicolumn{1}{c}{}&\multicolumn{1}{c}{RMSE}&\multicolumn{1}{c}{}&\multicolumn{1}{c}{RMSE}&\multicolumn{1}{c}{}&\multicolumn{1}{c}{RMSE}\tabularnewline
\hline
{\bfseries Adult}&&&&&&&&\tabularnewline
~~ETHNICITY&33& 5&&11,320&&1,879&&1,894\tabularnewline
~~NSSEC.ACTIVE&33& 9&& 5,049&&  738&&  734\tabularnewline
~~AGE.SEX&33&16&& 1,959&&  308&&  311\tabularnewline
~~EMPSTAT.LIVARR&33&11&& 3,852&&  554&&  566\tabularnewline
\hline
{\bfseries Household}&&&&&&&&\tabularnewline
~~ACCOM.TYPE&33& 4&&     2&&   38&&   39\tabularnewline
~~TENURE&33& 4&&     2&&  135&&  149\tabularnewline
~~CTAX.BAND&33& 8&&   704&&  705&&  705\tabularnewline
~~EMPLOY.STAT.74.HRP&33& 5&&    11&&   29&&   32\tabularnewline
~~HHOLD.TYPE&33& 9&&     0&&    0&&    0\tabularnewline
\hline
...
#+RESULTS[96b1645e751c7370d8278f622a789a6f57cd56dd]: table:rmse-2011-fit
#+BEGIN_LaTeX
 %latex.default(fit.11, file = "", numeric.dollar = FALSE, big.mark = ",",     cdec = rep(0, 5), n.rgroup = c(4, 5), rgroup = c("Adult",         "Household"), n.cgroup = c(2, 1, 1, 1), cgroup = c("Constraint",         "Hhold Only", "Multi-Level", "SPI"), caption = "Root mean squared error of the constraint variables in the three simulations, 2011",     label = "table:rmse-2011-fit")%
\begin{table}[!tbp]
\caption{Root mean squared error of the constraint variables in the three simulations, 2011\label{table:rmse-2011-fit}} 
\begin{center}
\begin{tabular}{lrrcrcrcr}
\hline\hline
\multicolumn{1}{l}{\bfseries fit.11}&\multicolumn{2}{c}{\bfseries Constraint}&\multicolumn{1}{c}{\bfseries }&\multicolumn{1}{c}{\bfseries Hhold Only}&\multicolumn{1}{c}{\bfseries }&\multicolumn{1}{c}{\bfseries Multi-Level}&\multicolumn{1}{c}{\bfseries }&\multicolumn{1}{c}{\bfseries SPI}\tabularnewline
\cline{2-3} \cline{5-5} \cline{7-7} \cline{9-9}
\multicolumn{1}{l}{}&\multicolumn{1}{c}{Areas}&\multicolumn{1}{c}{Classes}&\multicolumn{1}{c}{}&\multicolumn{1}{c}{RMSE}&\multicolumn{1}{c}{}&\multicolumn{1}{c}{RMSE}&\multicolumn{1}{c}{}&\multicolumn{1}{c}{RMSE}\tabularnewline
\hline
{\bfseries Adult}&&&&&&&&\tabularnewline
~~ETHNICITY&33& 5&&14,686&&2,156&&2,150\tabularnewline
~~NSSEC.ACTIVE&33&10&& 5,761&&1,338&&1,335\tabularnewline
~~AGE.SEX&33&16&& 2,462&&  522&&  519\tabularnewline
~~EMPSTAT.LIVARR&33&10&& 3,671&&  551&&  545\tabularnewline
\hline
{\bfseries Household}&&&&&&&&\tabularnewline
~~ACCOM.TYPE&33& 4&&     0&&   15&&   16\tabularnewline
~~TENURE&33& 4&&     0&&   95&&   94\tabularnewline
~~CTAX.BAND&33& 8&&   627&&  627&&  627\tabularnewline
~~EMPLOY.STAT.HRP&33& 5&&     5&&   10&&   10\tabularnewline
~~HHOLD.TYPE&33& 7&&     0&&    0&&    0\tabularnewline
\hline
\end{tabular}\end{center}
...
#+RESULTS[aec3340ad7307d5ef6a81b4880b0c629d480467f]: fig:orig_v_sim-deciles-2011
...
#+BEGIN_SRC R :exports results :results output graphics :file fig/sims-vs-gdhi.pdf :height 3 :width 4.5
  ...
  ggplot(final, aes(x=`2011`, y=inc.per.cap) ) +
      geom_point(aes(label=NUTS3), colour=red.2) +
      labs(y="SPI Simulation net household income per capita, 2011",
           x="Regional Accounts GDHI per capita, 2011") +
      coord_equal()
#+END_SRC
...
#+RESULTS[e46f1d995af6e3a130c67d77b50ac6e5fb04433c]: fig:sims-vs-gdhi
...
#+RESULTS[275b605e88e52e2f6d3e56ef93511446b3241cc3]: table:london_pov_rates-2011
#+BEGIN_LaTeX
 %latex.default(tbl, file = "", numeric.dollar = FALSE, ...)%
\begin{table}[!tbp]
\caption{Poverty rates (percentage of people in relative low income <60\% of median) 2011, HBAI and simulations\label{table:london_pov_rates-2011}} 
\begin{center}
\begin{tabular}{lrrrr}
\hline\hline
\multicolumn{1}{l}{Poverty rate (people)}&\multicolumn{1}{c}{HBAI}&\multicolumn{1}{c}{Household Only}&\multicolumn{1}{c}{Multi Level}&\multicolumn{1}{c}{SPI Adjusted}\tabularnewline
\hline
Before Housing Costs&15.8&14.6&16.2&16.1\tabularnewline
After Housing Costs&28.6&27.5&29.3&29.2\tabularnewline
\hline
\end{tabular}\end{center}
...
#+RESULTS[344cb04c2eb281d334bcffb1510914b647530dd6]:
#+BEGIN_LaTeX
 %latex.default(fam.tbl, digits = 2, file = "", title = "Data Source",     n.cgroup = c(2, 3), cgroup = c("Published Statistics", "Simulations"),     caption = "Proportion of adults aged 16+ living in a couple, 2011",     numeric.dollar = FALSE, label = "table-living-arrangements")%
\begin{table}[!tbp]
\caption{Proportion of adults aged 16+ living in a couple, 2011\label{table-living-arrangements}} 
\begin{center}
\begin{tabular}{lrrcrrr}
\hline\hline
\multicolumn{1}{l}{\bfseries Data Source}&\multicolumn{2}{c}{\bfseries Published Statistics}&\multicolumn{1}{c}{\bfseries }&\multicolumn{3}{c}{\bfseries Simulations}\tabularnewline
\cline{2-3} \cline{5-7}
\multicolumn{1}{l}{}&\multicolumn{1}{c}{Census 2011}&\multicolumn{1}{c}{HBAI}&\multicolumn{1}{c}{}&\multicolumn{1}{c}{Household Only}&\multicolumn{1}{c}{Multi Level}&\multicolumn{1}{c}{SPI Adjusted}\tabularnewline
\hline
In a Couple&0.48&0.57&&0.53&0.48&0.48\tabularnewline
Not in a Couple&0.52&0.43&&0.47&0.52&0.52\tabularnewline
\hline
\end{tabular}\end{center}
...
#+RESULTS[71cdbd0a56cd3f7ec685f857d3fb0a3e17acbce1]: table-districts-pov
#+BEGIN_LaTeX
 %latex.default(pov.brg, file = "", digits = 2, numeric.dollar = FALSE,     n.cgroup = c(2, 2, 2), cgroup = c("Hhold Only", "Multi-Level",         "SPI"), n.rgroup = c(5, 1, 5), rgroup = c("Highest",         "", "Lowest"), caption = "Boroughs with highest and lowest poverty rates (after housing costs) under the three simulations, 2011",     title = "Poverty", label = "table-districts-pov")%
\begin{table}[!tbp]
\caption{Boroughs with highest and lowest poverty rates (after housing costs) under the three simulations, 2011\label{table-districts-pov}} 
\begin{center}
\begin{tabular}{llrclrclr}
\hline\hline
\multicolumn{1}{l}{\bfseries Poverty}&\multicolumn{2}{c}{\bfseries Hhold Only}&\multicolumn{1}{c}{\bfseries }&\multicolumn{2}{c}{\bfseries Multi-Level}&\multicolumn{1}{c}{\bfseries }&\multicolumn{2}{c}{\bfseries SPI}\tabularnewline
\cline{2-3} \cline{5-6} \cline{8-9}
\multicolumn{1}{l}{}&\multicolumn{1}{c}{sl.name}&\multicolumn{1}{c}{sl.val}&\multicolumn{1}{c}{}&\multicolumn{1}{c}{ml.name}&\multicolumn{1}{c}{ml.val}&\multicolumn{1}{c}{}&\multicolumn{1}{c}{sp.name}&\multicolumn{1}{c}{sp.val}\tabularnewline
\hline
{\bfseries Highest}&&&&&&&&\tabularnewline
~~1&Newham&0.37&&Newham&0.43&&Newham&0.43\tabularnewline
~~2&Hackney&0.36&&Tower Hamlets&0.41&&Tower Hamlets&0.41\tabularnewline
~~3&Tower Hamlets&0.33&&Brent&0.35&&Brent&0.35\tabularnewline
~~4&Haringey&0.32&&Hackney&0.35&&Hackney&0.35\tabularnewline
~~5&Lewisham&0.31&&Haringey&0.33&&Haringey&0.33\tabularnewline
\hline
{\bfseries }&&&&&&&&\tabularnewline
~~ &&&&&&&&\tabularnewline
\hline
{\bfseries Lowest}&&&&&&&&\tabularnewline
~~29&Sutton&0.23&&Bromley&0.22&&City of London&0.22\tabularnewline
~~30&Richmond u.T.&0.21&&Sutton&0.22&&Sutton&0.22\tabularnewline
~~31&Havering&0.21&&Bexley&0.21&&Bexley&0.21\tabularnewline
~~32&City of London&0.21&&Richmond u.T.&0.20&&Havering&0.20\tabularnewline
~~33&Bexley&0.21&&Havering&0.20&&Richmond u.T.&0.20\tabularnewline
\hline
\end{tabular}\end{center}
...
#+BEGIN_SRC R :exports results :results output graphics :file fig/sims-vs-umbr.pdf :width 4.5 :height 3.5
  if ( ! exists("umbr.l") ) {
...
#+RESULTS[fe7aff0ee75664030da83dfe5f5f2a20fb45d710]: fig:sims-vs-umbr
...
#+RESULTS[ae0edb18003d0bd634c53deba2809521ead8e39f]: fig:ashe_earns
...
#+RESULTS[e057fe8ff1c496e3187490dc29d9c93625dc2f3d]:
#+BEGIN_LaTeX
 %latex.default(tbl, file = "", numeric.dollar = FALSE, ...)%
\begin{table}[!tbp]
\caption{Boroughs with highest and lowest Gini coefficients of income inequality (equivalised income after housing costs) under two simulations, 2011\label{table-gini-topbot-2011}} 
\begin{center}
\begin{tabular}{llrclr}
\hline\hline
\multicolumn{1}{l}{\bfseries Gini coefficient}&\multicolumn{2}{c}{\bfseries Multi-Level}&\multicolumn{1}{c}{\bfseries }&\multicolumn{2}{c}{\bfseries SPI}\tabularnewline
\cline{2-3} \cline{5-6}
\multicolumn{1}{l}{}&\multicolumn{1}{c}{Borough}&\multicolumn{1}{c}{Gini}&\multicolumn{1}{c}{}&\multicolumn{1}{c}{Borough}&\multicolumn{1}{c}{Gini}\tabularnewline
\hline
{\bfseries Highest}&&&&&\tabularnewline
~~1&Kensington and Chelsea&0.56&&Kensington and Chelsea&0.61\tabularnewline
~~2&City of London&0.56&&Westminster&0.60\tabularnewline
~~3&Westminster&0.55&&City of London&0.59\tabularnewline
~~4&Hammersmith and Fulham&0.53&&Camden&0.57\tabularnewline
~~5&Camden&0.53&&Hammersmith and Fulham&0.56\tabularnewline
\hline
{\bfseries }&&&&&\tabularnewline
~~ &&&&&\tabularnewline
\hline
{\bfseries Lowest}&&&&&\tabularnewline
~~29&Newham&0.37&&Newham&0.36\tabularnewline
~~30&Waltham Forest&0.37&&Waltham Forest&0.35\tabularnewline
~~31&Havering&0.36&&Havering&0.35\tabularnewline
~~32&Bexley&0.35&&Bexley&0.34\tabularnewline
~~33&Barking and Dagenham&0.34&&Barking and Dagenham&0.32\tabularnewline
\hline
\end{tabular}\end{center}
...
#+BEGIN_SRC R :exports results :results output graphics :file fig/sim_housing_ben.pdf :height 3.5 :width 4.5
  ...
  ggplot(hsgben, aes(x=HB.Actual/Benefit.Units*1000,
                     y=HB.Sim/Benefit.Units*1000) ) +
    geom_point(aes(size=Benefit.Units, colour=InOutLondon)) +
    ## geom_smooth(method="lm", aes(weight=Benefit.Units), se=FALSE)
    scale_x_continuous("Actual HB Claims (/1000 Benefit Units)") +
    scale_y_continuous("Simulated HB Claims (/1000 Benefit Units)") +
...
#+LABEL: fig:hsg-ben
#+CAPTION[Comparison of simulated and actual Housing Benefit claims, 2011]: Simulated against actual housing benefit rates (claims per thousand benefit units), London boroughs, 2011. Figures from the SPI simulation shown against DWP's published figures for June 2011.
#+RESULTS[043217a85c7dd4ba5e2eb77cdcff58b08f828257]: fig:hsg-ben
